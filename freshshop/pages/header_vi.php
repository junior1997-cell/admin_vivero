...
<head>
    ...
    <link rel="apple-touch-icon" href="../images/simbolo.jpeg">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav" style="    height: 70px !important;">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="../pages/index.php"><img src="../images/upeu/oficialogo.png" width="430" height="100" style="margin-left: -20%; margin-top: -1px" class="logo" alt=""></a>
                </div>
