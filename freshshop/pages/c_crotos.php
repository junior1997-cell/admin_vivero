			...
			<div class="row  classrow">
				<div class="col-lg-1 col-md-2 col-sm-12 entornodiv">
					<div class="imgpequeño ecfecto " id="imagenesP">
						<center>
							<img src="../images/upeu/crotos.png" id="image1">
					    </center>
					</div>
				...
				<div class="col-lg-7 col-md-10 col-sm-12">
					<div class="imgestilo">
						<center>
							<figure>							
									<img id="vidadigital" src="crotos.png" title="Vida Verde">
							</figure>
					    </center>
					</div>
				</div>
				<div class="col-lg-4 col-md-12 col-sm-12 rowww divhead">
					...
					<center>
						<span id="nombre_pl">Crotos</span>
						<form>
							<div class="precio">
						<hr>						
						<h4 class="h2" id="precio">S/ 32.00</h4>
...
document.querySelector('#submit').addEventListener('click',function(){
  ...
  // alert(precio);
    ...
    let url = "https://api.whatsapp.com/send?phone=+51916711593&text=*_universidad Peruana Unión_*%0A*Vivero UPeU*%0A%0A*¿Nombre de la planta?*%0A" + nombre_planta + "%0A*Cantidad*%0A" + cantidad + "%0A*precio por unidad*%0A"  + precio + "%0A*¡Gracias por su preferencia!*%0A";
    window.open(url);
