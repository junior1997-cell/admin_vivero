        ...
        3: [
          function (t, e, n) {
            ...
            (o.prototype = {
              ...
              (o.prototype.spaces = { rgb: ["red", "green", "blue"], hsl: ["hue", "saturation", "lightness"], hsv: ["hue", "saturation", "value"], hwb: ["hue", "whiteness", "blackness"], cmyk: ["cyan", "magenta", "yellow", "black"] }),
              ...
              (n.doughnut = {
                ...
                (t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                  ...
                  updateElement: function (t, n, i) {
                    ...
                    e.extend(t, { _datasetIndex: a.index, _index: n, _model: { x: u + o.offsetX, y: d + o.offsetY, startAngle: c, endAngle: h, circumference: g, outerRadius: m, innerRadius: p, label: v(f.label, n, o.data.labels[n]) } });
                    var b = t._model;
                  ...
                  draw: function (e) {
                    ...
                    if (o.display) {
                      ...
                      if (p) {
                        if (
                          ((r = !1),
                          (M + d.autoSkipPadding) * a.ticks.length > a.width - (a.paddingLeft + a.paddingRight) && (r = 1 + Math.floor(((M + d.autoSkipPadding) * a.ticks.length) / (a.width - (a.paddingLeft + a.paddingRight)))),
                          l && a.ticks.length > l)
                        )
                  ...
                  draw: function (e) {
                    ...
                    n.skip ||
                      ...
                      void 0 !== e &&
                        ...
                        (r.x < e.left ? (g = (d - r.x) / (e.left - r.x)) : e.right * f < r.x ? (g = (r.x - d) / (r.x - e.right)) : r.y < e.top ? (g = (c - r.y) / (e.top - r.y)) : e.bottom * f < r.y && (g = (r.y - c) / (r.y - e.bottom)),
                    ...
                    if (a.display) {
                      ...
                      i.each(n.legendItems, function (t, e) {
                        var i = c.measureText(t.text).width,
                          ...
                          r = d.x,
                          l = d.y;
                        w ? r + a >= s && ((l = d.y += M), d.line++, (r = d.x = n.left + (s - u[d.line]) / 2)) : l + M > n.bottom && ((r = d.x = r + n.columnWidths[d.line] + o.padding), (l = d.y = n.top + o.padding), d.line++),
                          y(r, l, t),
                          (x[e].left = r),
                          (x[e].top = l),
                          k(r, l, t, i),
                      ...
                      e.each(l, function (i, a) {
                        ...
                        o.isDatasetVisible(a) &&
                          ...
                          e.each(i.data, function (t, e) {
                            ...
                            isNaN(i) ||
                              r.data[e].hidden ||
                              (null === n.min ? (n.min = i) : i < n.min && (n.min = i), null === n.max ? (n.max = i) : i > n.max && (n.max = i), 0 !== i && (null === n.minNotZero || i < n.minNotZero) && (n.minNotZero = i));
                          });
                      });
                    (n.min = s(a.min, n.min)),
                      (n.max = s(a.max, n.max)),
                    ...
                    return (
                      o.isHorizontal()
                        ...
                        : ((n = o.height),
                          0 !== r || u.reverse
                            ? 0 === o.end && u.reverse
                              ? ((a = e.log10(o.start) - e.log10(o.minNotZero)), (i = l === o.end ? o.top : l === o.minNotZero ? o.top + 0.02 * n : o.top + 0.02 * n + ((0.98 * n) / a) * (e.log10(l) - e.log10(o.minNotZero))))
                              : 0 === l
                              ? (i = u.reverse ? o.top : o.bottom)
                              : ((a = e.log10(o.end) - e.log10(r)), (n = o.height), (i = o.bottom - (n / a) * (e.log10(l) - e.log10(r))))
                            : ((a = e.log10(o.end) - e.log10(o.minNotZero)), (i = l === r ? o.bottom : l === o.minNotZero ? o.bottom - 0.02 * n : o.bottom - 0.02 * n - ((0.98 * n) / a) * (e.log10(l) - e.log10(o.minNotZero))))),
                      i
                    );
                  },
                  getValueForPixel: function (t) {
