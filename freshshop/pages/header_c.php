...
<head>
   ...
   <!-- <link rel="stylesheet" type="text/css" href="../../admin/public/css/bootstrap-select.min.css">-->
            ...
            <div class="row" >
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="right-phone-box">
                        <p>TELEFONO<a href="#"> +51 989 059 400</a></p>
                    </div>
                    <div class="our-link">
                        <ul>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav" style="    height: 70px !important;">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="../images/upeu/oficialogo.png" width="350"  style="margin-left: -10%; margin-top: -8px" class="logo" alt=""></a>
                </div>
