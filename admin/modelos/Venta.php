...
Class Venta
{
	...
	{
		$sql="SELECT v.idventa,DATE(v.fecha_hora) as fecha,v.idcliente,p.nombre as cliente,u.idusuario,u.nombre as usuario,v.tipo_comprobante,v.serie_comprobante,v.num_comprobante,v.total_venta,v.impuesto,v.estado FROM admin_vivero.venta v INNER JOIN admin_vivero.persona p ON v.idcliente=p.idpersona INNER JOIN admin_vivero.usuario u ON v.idusuario=u.idusuario WHERE v.idventa='$idventa'";
		return ejecutarConsultaSimpleFila($sql);
	}

	public function listarDetalle($idventa)
	{
		$sql="SELECT dv.idventa,dv.idplanta,p.nombre,dv.cantidad,dv.precio_venta,dv.descuento,(dv.cantidad*dv.precio_venta-dv.descuento) as subtotal FROM admin_vivero.detalle_venta dv inner join admin_vivero.planta p on dv.idplanta=p.idplanta where dv.idventa='$idventa'";
		return ejecutarConsulta($sql);
	}
	...
	public function ventadetalle($idventa){
		$sql="SELECT a.idplanta, a.nombre as planta, d.cantidad, d.precio_venta, d.descuento, (d.cantidad*d.precio_venta-d.descuento) as subtotal 
		FROM detalle_venta d INNER JOIN planta a ON d.idplanta=a.idplanta WHERE d.idventa='$idventa';";
		return ejecutarConsulta($sql);
	}
