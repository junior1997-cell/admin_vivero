			...
			<div class="row  classrow">
				<div class="col-lg-1 col-md-2 col-sm-12 entornodiv">
					<div class="imgpequeño ecfecto " id="imagenesP">
						<center>
							<img src="../images/upeu/begoña rastreras.png" title="Vida Verde">
					    </center>
					</div>
				...
				<div class="col-lg-7 col-md-10 col-sm-12">
					<div class="imgestilo">
						<center>
							<figure>
							<img id="vidadigital" src="../images/upeu/begoña rastreras.png" title="Vida Verde">
							</figure>
					    </center>
					</div>
				</div>
				<div class="col-lg-4 col-md-12 col-sm-12 rowww divhead">
					...
					<center>
						<span id="nombre_pl">Begoña Rastreras</span>
						<form>
							<div class="precio">
						<hr>						
						<h4 class="h2" id="precio">S/ 35.00</h4>
...
?>
<script type="text/javascript" src="carrito/js/c_borgoña_rastreras.js"></script>
