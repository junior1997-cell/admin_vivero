...
if (!isset($_SESSION["nombre"])) {
  ...
  if ($_SESSION['ventas'] == 1) {
    ...
    //require('Factura.php');
    require('Factura_v2.php');

    //Establecemos los datos de la empresa
    $logo = "logo.jpeg";
    $ext_logo = "jpeg";
    $empresa = "VIVERO UPEU";
    $documento = "0138122256";
    $direccion = "Jr. Los Martires";
    $telefono = "931742904";
    ...
    while ($regd = $rsptad->fetch_object()) {
      ...
      // echo($regd->planta);
      $line = array(
        "CODIGO" => "000$regd->idplanta",
        "DESCRIPCION" => utf8_decode("$regd->planta"),
    ...
    $pdf->addTVAs(number_format($regv->total_venta, 2, '.',','), number_format($regv->impuesto, 2, '.',','), number_format($regv->total_venta, 2, '.',','), "S/ ");
