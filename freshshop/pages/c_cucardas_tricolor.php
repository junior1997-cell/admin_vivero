			...
			<div class="row  classrow">
				<div class="col-lg-1 col-md-2 col-sm-12 entornodiv">
					<div class="imgpequeño ecfecto " id="imagenesP">
						<center>
							<img src="../images/upeu/cucarda tricolor.png">
							<img src="../images/upeu/cucardas tricolor.png">
					    </center>
					</div>
				...
				<div class="col-lg-7 col-md-10 col-sm-12">
					<div class="imgestilo">
						<center>
							<figure>
							<img id="cucardat" src="" title="Vida Verde">
							</figure>
					    </center>
					</div>
				</div>
				<div class="col-lg-4 col-md-12 col-sm-12 rowww divhead">
					...
					<center>
						<span id="nombre_pl">Buganvilla</span>
						<form>
							<div class="precio">
						<hr>						
						<h4 class="h2" id="precio">S/ 30.00</h4>
...
?>
<script type="text/javascript" src="carrito/js/c_cucarda_tric.js"></script>
