                    ...
                    this.$button.on("click.dropdown.data-api", function () {
                        ...
                        this.$searchbox.on("input propertychange", function () {
                            if ((c.$lis.not(".is-hidden").removeClass("hidden"), c.$lis.filter(".active").removeClass("active"), d.remove(), c.$searchbox.val())) {
                                ...
                                if (
                                    ((e = c.options.liveSearchNormalize ? f.find("a").not(":a" + c._searchStyle() + '("' + b(c.$searchbox.val()) + '")') : f.find("a").not(":" + c._searchStyle() + '("' + c.$searchbox.val() + '")')),
                                    e.length === f.length)
                                )
                ...
                keydown: function (c) {
                    ...
                    if (
                        (o.options.liveSearch &&
                            (/(^9$|27)/.test(c.keyCode.toString(10)) && l && (c.preventDefault(), c.stopPropagation(), o.$menuInner.click(), o.$button.focus()),
                        ...
                        if (/(38|40)/.test(c.keyCode.toString(10)))
                            (e = d.index(d.find("a").filter(":focus").parent())),
                                ...
                                (k = m.data("prevIndex")),
                                38 == c.keyCode
                                    ? (o.options.liveSearch && e--, e != j && e > i && (e = i), e < g && (e = g), e == k && (e = h))
                                    : 40 == c.keyCode && (o.options.liveSearch && e++, e == -1 && (e = 0), e != j && e < f && (e = f), e > h && (e = h), e == k && (e = g)),
                                m.data("prevIndex", e),
