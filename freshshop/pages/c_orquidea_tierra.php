			...
			<div class="row  classrow">
				<div class="col-lg-1 col-md-2 col-sm-12 entornodiv">
					<div class="imgpequeño ecfecto " id="imagenesP">
						<center>
							<img src="../images/upeu/orquidea de tierra.png" id="image1">
					    </center>
					</div>
				...
				<div class="col-lg-7 col-md-10 col-sm-12">
					<div class="imgestilo">
						<center>
							<figure>
							<img id="orquidea" src="../images/upeu/orquidea de tierra.png" title="Vida Verde">
							</figure>
					    </center>
					</div>
				</div>
				<div class="col-lg-4 col-md-12 col-sm-12 rowww divhead">
					...
					<center>
						<span id="nombre_pl">Orquidea De Tierra</span>
						<form>
							<div class="precio">
						<hr>						
