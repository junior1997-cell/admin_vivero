                ...
                // alert(srcall);
                    ...
                    // alert(srcall);
                        document.getElementById("vidadigital").src =srcall;
                            ...
                            var secc_img_p = ''+
                            '<center>'+
                                '<img src="../../admin/files/articulos/rosa_defecto_v.svg" id="image1">'+
                            '</center>'+
                            '';
                            $("#img_peque").append(secc_img_p);
...
document.querySelector('#submit').addEventListener('click',function(){
    ...
    let url = "https://api.whatsapp.com/send?phone=+51"+whatsapp+"&text=*__Universidad Peruana Unión__*%0A*Vivero UPeU*%0A%0A*¿Nombre de la planta?*%0A" + nombre + "%0A*Precio por unidad*%0A" + precio + "%0A*Cantidad*%0A" + cantidad + "%0A*Color de preferencia*%0A" + c_preferencia + "%0A*¡Gracias por su preferencia!*%0A%0A*¡EN SEGUIDA CONFIRMAMOS SU PEDIDO!*%0A";
    window.open(url);
