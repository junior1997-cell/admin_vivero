			...
			<div class="row  classrow">
				<div class="col-lg-1 col-md-2 col-sm-12 entornodiv">
					<div class="imgpequeño ecfecto " id="imagenesP">
						<center>
							<img src="../images/upeu/trepadora con flor morada.png" id="image1">
					    </center>
					</div>
				...
				<div class="col-lg-7 col-md-10 col-sm-12">
					<div class="imgestilo">
						<center>
							<figure>
							<img id="panameñas" src="../images/upeu/trepadora con flor morada.png" title="Vida Verde">
							</figure>
					    </center>
					</div>
				</div>
				<div class="col-lg-4 col-md-12 col-sm-12 rowww divhead">
					...
					<center>
						<span id="nombre_pl">Trepadora Con Flor Morada</span>
						<form>
							<div class="precio">
						<hr>						
						<h4 class="h2" id="precio">S/ 40.00</h4>
